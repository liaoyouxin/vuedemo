<template>
  <div class="publish-wrap">
      <div class="selection">
      	<h2 class="title">广告发布</h2>
      	<p class="des">历史资料、科学实验、检验、统计等所获得的和用于科学研究、技术设计、查证、决策等的数值加以统计为解决方案做前期准备。</p>
      	<div class="buy-control">
      		<div class="buynum">
      			<span class="label">购买数量 : </span>
      			<div class="select-div">
      				<vue-counter :max=10></vue-counter>
      			</div>
      		</div>
      		<div class="price">
      			<span class="label">行业 : </span>
      			<div class="select-div">
      				<vue-selection :selections="trades"></vue-selection>
      			</div>
      		</div>
      		<div class="type">
      			<span class="label">选择媒介 : </span>
      			<div class="select-div">
      				<multiply-chooser :selections="versions"></multiply-chooser>
      			</div>
      		</div>
      		<div class="time">
